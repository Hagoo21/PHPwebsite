...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['owner_submit'])) {
        ...
        $_SESSION['user_id'] = $owner_ID; // Assuming owner ID is used as the user ID
        ...
        // Set user ID in session
        $_SESSION['user_id'] = $manager_ID; // Assuming manager ID is used as the user ID
        ...
        // Set user ID in session
        $_SESSION['user_id'] = $renter_ID; // Assuming renter ID is used as the user ID
    }
}
